...
TERMINFO="/sandbox/maps/maps_server/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /sandbox/maps/build/ncurses-5.9/man_alias.sed ; then
cat >>/sandbox/maps/build/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /sandbox/maps/build/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /sandbox/maps/build/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /sandbox/maps/build/ncurses-5.9/man_alias.sed \
		< $i >$TMP
